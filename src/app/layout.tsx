...
const SITE_NAME = "Jack's World";
const SITE_TITLE = "Jack's World — Monitoring the Situation | Live Flight Tracking, CCTV, OSINT Tools & More";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Jack's World — Monitoring the Situation | Live Flights, CCTV, Satellites & OSINT Tools",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Jack's World — Monitoring the Situation with Live Tracking & OSINT Tools",
        type: "image/png",
      },
    ],
  },
  twitter: {
    ...
    title: "🛰️ Jack's World — Monitoring the Situation | Live Tracking + OSINT Tools",
  ...
  other: {
    ...
    "apple-mobile-web-app-title": "Jack's World",
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  name: "Jack's World — Monitoring the Situation",
  alternateName: ["Jack's World", "OSIRIS", "OsirisAI"],
  url: SITE_URL,
  description: SITE_DESCRIPTION,
  ...
  return (
    <html lang="en" dir="ltr">
      ...
      <body className="antialiased">
        <ErrorBoundary name="Jack's World Core">
          {children}
        </ErrorBoundary>
      </body>
    </html>
